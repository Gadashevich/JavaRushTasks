...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        list.sort((a, b) -> {
            double changeA = a.containsKey("change") ? (double) a.get("change") : (double) a.get("last") - (double) a.get("open");
            double changeB = b.containsKey("change") ? (double) b.get("change") : (double) b.get("last") - (double) b.get("open");
            return Double.compare(changeB, changeA);
        });
        list.sort((a, b) -> {
            Date date1 = (Date) a.get("date");
            Date date2 = (Date) b.get("date");
            LocalDate localDate1 = LocalDate.of(date1.getYear() + 1900, date1.getMonth() + 1, date1.getDay() == 0 ? 7 : date1.getDate());
            LocalDate localDate2 = LocalDate.of(date2.getYear() + 1900, date2.getMonth() + 1, date2.getDay() == 0 ? 7 : date2.getDate());
